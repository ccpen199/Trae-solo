...
ensure_tmux_service "may-89232-backend" "${BACKEND_PORT}" "backend/server.py" backend.pid backend.log "/usr/bin/python3 backend/server.py"
ensure_tmux_service "may-89232-frontend" "${FRONTEND_PORT}" "scripts/frontend_server.py" frontend.pid frontend.log "/usr/bin/python3 scripts/frontend_server.py"
