...
export interface AppState {
  ...
  doTrends: DissolvedOxygenTrend[];
  aerationPlans: AerationPlan[];
  ...
  powerSwitchPlans: PowerSwitchPlan[];
...
export interface AppActions {
  ...
  setDOTrends: (trends: DissolvedOxygenTrend[]) => void;
  setAerationPlans: (plans: AerationPlan[]) => void;
  updateAerationPlan: (plan: AerationPlan) => void;
  setPowerStatus: (status: PowerStatus) => void;
  setFeedingPlans: (plans: FeedingPlan[]) => void;
  ...
  setBusinessNodes: (nodes: BusinessNode[]) => void;
  updateBusinessNode: (node: BusinessNode) => void;
  setPowerSwitchPlans: (plans: PowerSwitchPlan[]) => void;
  setWaterQualityReports: (reports: WaterQualityReport[]) => void;
