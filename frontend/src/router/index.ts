  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () => import('@/views/materials/InventoryView.vue'),
            meta: { title: '库存管理', roles: ['purchaser', 'factory', 'admin'] as Role[] },
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            meta: { title: '采购订单', roles: ['purchaser', 'admin'] as Role[] },
          },
          {
            path: 'create',
            name: 'PurchaseOrderCreate',
            component: () => import('@/views/purchases/PurchaseForm.vue'),
            meta: { title: '新建采购单', roles: ['purchaser', 'admin'] as Role[] },
          },
          {
            path: ':id',
            name: 'PurchaseOrderDetail',
            component: () => import('@/views/purchases/PurchaseDetailView.vue'),
            meta: { title: '采购单详情', roles: ['purchaser', 'admin'] as Role[] },
          },
        ],
      },
      {
        path: 'production',
        name: 'Production',
        meta: { title: '生产管理', icon: 'Connection' },
        children: [
          {
            path: '',
            name: 'ProductionOrderList',
            component: () => import('@/views/production/ProductionList.vue'),
            meta: { title: '生产工单', roles: ['factory', 'admin'] as Role[] },
          },
          {
            path: ':id',
            name: 'ProductionDetail',
            component: () => import('@/views/production/ProductionDetailView.vue'),
            meta: { title: '生产详情', roles: ['factory', 'designer', 'admin'] as Role[] },
          },
          {
            path: 'issues',
            name: 'ProductionIssues',
            component: () => import('@/views/production/IssueListView.vue'),
            meta: { title: '异常问题', roles: ['factory', 'designer', 'admin'] as Role[] },
          },
        ],
      },
      {
      ...
      },
      {
        path: 'communications',
        name: 'Communications',
        component: () => import('@/views/communications/CommunicationView.vue'),
        meta: { title: '协同沟通', icon: 'ChatDotRound' },
      },
      {
        path: 'reports',
        name: 'Reports',
        ...
        children: [
          {
            path: 'styles',
            name: 'StyleReport',
            component: () => import('@/views/reports/StyleReportView.vue'),
            meta: { title: '款式报表', roles: ['admin'] as Role[] },
          },
          {
            path: 'production',
            name: 'ProductionReport',
            component: () => import('@/views/reports/ProductionReportView.vue'),
            meta: { title: '生产报表', roles: ['admin', 'factory'] as Role[] },
          },
        ],
      },
    ],
