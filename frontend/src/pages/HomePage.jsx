...
export default function HomePage({ currentCity }) {
  ...
  const movies = [
    { id: 1, title: '流浪地球3', rating: 9.2, poster: 'https://picsum.photos/300/400?random=1' },
    { id: 2, title: '热辣滚烫', rating: 8.5, poster: 'https://picsum.photos/300/400?random=2' },
    { id: 3, title: '封神第三部', rating: 8.8, poster: 'https://picsum.photos/300/400?random=3' },
    { id: 4, title: '红海行动2', rating: 8.6, poster: 'https://picsum.photos/300/400?random=4' },
    { id: 5, title: '唐人街探案4', rating: 8.3, poster: 'https://picsum.photos/300/400?random=5' },
    { id: 6, title: '复仇者联盟5', rating: 8.9, poster: '    { id: 6, title: '复仇者联盟5', rating: 8.9, poster: '    { id: 6, title: '复仇者联盟5', rating: 8.9, poster: '    { id: 6, title: '复, b    { id: 6, tite', padding: '16px', boxShadow: '0 1px 4px rgba(0,0,0,0.1)', zIndex: 100 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', padding: '16px' }}>
        {movies.map(movie => (
          <div key={movie.id} style={{ background: 'white', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', cursor: 'pointer' }} onClick={() => navigate(`/movie/${movie.id}`)}>
            <img src={movie.poster} alt={movie.title} style={{ width: '100%', aspectRatio: '3/4', objectFit: 'cover' }} />
