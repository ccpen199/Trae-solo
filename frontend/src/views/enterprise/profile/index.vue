    ...
    <el-card>
      ...
      >
        ...
        <el-form-item label="企业编号">
          <el-input v-model="userInfo.enterprise?.enterpriseCode" disabled />
        </el-form-item>
        <el-form-item label="企业名称">
          <el-input v-model="userInfo.enterprise?.enterpriseName" disabled />
        </el-form-item>
        <el-form-item label="企业类型">
          <el-tag>{{ enterpriseTypeMap[userInfo.enterprise?.type || 'logistics'] }}</el-tag>
        </el-form-item>
        ...
        <el-form-item label="角色">
          <el-tag type="primary">企业用户</el-tag>
        </el-form-item>
...
import { EnterpriseType, enterpriseTypeMap } from '@/types';
