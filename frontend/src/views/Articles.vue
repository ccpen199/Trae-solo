      ...
      <div class="main-content">
        <div class="card">
          <div class="flex-between" style="margin-bottom: 20px;">
            ...
            <el-button type="primary" @click="router.push('/articles/new')" v-if="userStore.isLoggedIn">
          ...
          <div v-else class="content-list">
            ...
            >
              <div v-if="item.cover" class="article-cover">
                <el-image :src="item.cover" fit="cover" :preview-src-list="[item.cover]" />
              </div>
              <div class="article-content" :class="{ 'has-cover': !!item.cover }">
                <div class="item-header">
                  <el-tag type="success" size="small">文章</el-tag>
                  <span class="text-muted" style="margin-left: 8px;">
                    {{ item.category_name || '未分类' }}
                  </span>
                  <span v-if="item.tags?.length" class="ml-8">
                    <span v-for="tag in item.tags.slice(0, 3)" :key="tag" class="tag-item">{{ tag }}</span>
                  </span>
                </div>
                <h3 class="item-title ellipsis-1">{{ item.title }}</h3>
                <p class="item-excerpt ellipsis-2">
                ...
                <div class="item-meta">
                  ...
                  <div class="flex-center flex-gap-12 text-muted">
                    ...
                    <span><el-icon><ChatDotRound /></el-icon> {{ item.comments_count || 0 }}</span>
      ...
      <div class="sidebar">
        <div class="card sidebar-card">
          ...
          <div class="quick-actions">
            <el-button type="primary" style="width: 100%;" @click="router.push('/articles/new')">
              <el-icon><Document /></el-icon>
              发布文章
            </el-button>
          </div>
...
import { View, ChatDotRound, Star, Document } from '@element-plus/icons-vue';
