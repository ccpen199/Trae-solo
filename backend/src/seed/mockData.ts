...
export function generateMockJobFairs(): JobFair[] {
  const fairs = [
    { title: '云南省2024年春季大型招聘会', code: '530000', organizer: '云南省人力资源和社会保障厅', isLive: true },
    { title: '昆明市高校毕业生专场招聘会', code: '530100', organizer: '昆明市人力资源和社会保障局', isLive: true },
    { title: '曲靖市制造业专场招聘会', code: '530300', organizer: '曲靖市人力资源和社会保障局', isLive: false },
    { title: '玉溪市烟草产业专场招聘会', code: '530400', organizer: '玉溪市人力资源和社会保障局', isLive: false },
    { title: '普洱市茶产业人才招聘会', code: '530800', organizer: '普洱市人力资源和社会保障局', isLive: true },
    { title: '西双版纳州旅游人才专场招聘会', code: '532800', organizer: '西双版纳州人力资源和社会保障局', isLive: true },
    { title: '大理州文化旅游产业招聘会', code: '532900', organizer: '大理州人力资源和社会保障局', isLive: false },
    { title: '楚雄州生物医药产业专场招聘会', code: '532300', organizer: '楚雄州人力资源和社会保障局', isLive: false },
    { title: '红河州有色金属产业招聘会', code: '532500', organizer: '红河州人力资源和社会保障局', isLive: false },
    { title: '云南省2024年夏季大型招聘会', code: '530000', organizer: '云南省人力资源和社会保障厅', isLive: true },
  ];
  ...
  return fairs.map((fair, index) => {
    ...
    return {
      ...
      location: `${fair.code}会展中心`,
      start_time: startDate.toISOString(),
      end_time: endDate.toISOString(),
      status: status,
      description: `${fair.title}将于${startDate.toLocaleDateString()}举办，诚邀各用人单位和求职者参加。`,
      max_companies: 200 + index * 50,
      registered_companies: 150 + index * 30,
      max_visitors: 5000 + index * 1000,
      registered_visitors: 3000 + index * 800,
      is_live: fair.isLive,
      live_url: fair.isLive ? `https://live.yunnan-job.com/fair/${index + 1}` : '',
