...
const PlatformLayout: React.FC = () => {
  ...
  const menuItems = [
    ...
    {
      key: '/platform/tasks/publish',
      icon: <PlusOutlined />,
      label: '发布办件',
      onClick: () => navigate('/platform/tasks/publish')
    },
    {
      key: '/platform/talent',
      icon: <TeamOutlined />,
      label: '人才库',
      onClick: () => navigate('/platform/talent')
    },
    {
      key: '/platform/disputes',
      icon: <AlertOutlined />,
      label: '争议中心',
      onClick: () => navigate('/platform/disputes')
    },
    {
      key: '/platform/finance',
      icon: <WalletOutlined />,
      label: '财务中心',
      onClick: () => navigate('/platform/finance')
    },
    {
            ...
            <Dropdown menu={{ items: userMenu }} placement="bottomRight">
              <div className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 px-3 py-1.5 rounded-lg transition-colors">
                ...
                <div className="hidden sm:block">
                  ...
                  <div className="text-xs text-gray-500">平台运营</div>
                </div>
              </div>
            </Dropdown>
          </div>
