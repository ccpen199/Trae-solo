...
const PlatformDisputes: React.FC = () => {
      ...
      >
        ...
        >
          <Form.Item
            name="taskId"
            label="选择办件"
            rules={[{ required: true, message: '请选择办件' }]}
          >
            <Select placeholder="请选择需要申诉的办件" showSearch optionFilterProp="children">
              {tasks.map(task => (
        ...
        {currentDispute && (
          <div>
            <Descriptions bordered column={2} className="mb-6">
              ...
              <Descriptions.Item label="办件">{currentDispute.taskTitle}</Descriptions.Item>
