      ...
      <Alert
        ...
        description={
          <ul className="m-0 pl-4">
            ...
            <li>常州市公共服务聚合平台仲裁将在 3-5 个工作日内完成调查并给出裁决</li>
      ...
      >
        <Form form={form} layout="vertical">
          <Form.Item
            name="taskId"
            label="选择办件"
            rules={[{ required: true, message: '请选择相关办件' }]}
          >
            <Select placeholder="请选择有争议的办件" showSearch>
              {tasks.map(task => (
        ...
        {currentDispute && (
          <div>
            <Descriptions bordered column={2} className="mb-6">
              ...
              <Descriptions.Item label="办件名称" span={2}>
