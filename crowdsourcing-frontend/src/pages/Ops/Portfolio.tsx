            ...
            <Col span={12}>
              ...
              >
                <Select
                  ...
                  tokenSeparators={[',']}
                >
                  <Option value="政务办事">政务办事</Option>
                  <Option value="民生服务">民生服务</Option>
                  <Option value="社区治理">社区治理</Option>
            ...
            <Col span={12}>
              <Form.Item name="tools" label="使用工具">
                <Select
                  ...
                  tokenSeparators={[',']}
                >
                  <Option value="政务系统">政务系统</Option>
                  <Option value="数据平台">数据平台</Option>
                  <Option value="监控工具">监控工具</Option>
                  <Option value="运维平台">运维平台</Option>
                  <Option value="Python">Python</Option>
                  <Option value="SQL">SQL</Option>
