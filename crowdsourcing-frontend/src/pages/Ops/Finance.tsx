...
const TRANSACTION_TYPE: Record<string, { text: string; icon: React.ReactNode; color: string }> = {
  income: { text: '办件收入', icon: <ArrowDownOutlined />, color: 'text-green-600' },
      ...
      <Row gutter={[16, 16]} className="mb-6">
        ...
        <Col xs={24} sm={12} lg={6}>
          <Card>
            ...
            <div className="mt-2">
              <Text type="secondary" className="text-sm">
                共 {overview?.completedTasks || 25} 个办件
              </Text>
            </div>
          </Card>
        </Col>
          ...
          <div>
            <Descriptions bordered column={2} className="mb-4">
              ...
              {currentTransaction.task && (
                <>
                  <Descriptions.Item label="相关办件" span={2}>
