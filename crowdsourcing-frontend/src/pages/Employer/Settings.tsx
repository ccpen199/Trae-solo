...
const Settings: React.FC = () => {
  ...
  const tabItems = [
    ...
    {
      key: 'verify',
      label: <span><SafetyOutlined />企业认证</span>,
      children: (
        <div>
          <Card className="mb-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-800 mb-1">
                    {userInfo?.verified ? '企业认证已通过' : '尚未完成企业认证'}
                  </h3>
                  <p className="text-gray-500">
                    {userInfo?.verified
                      ? '您的企业认证已通过，享受更多平台权益'
                      : '完成企业认证可获得更多平台权益，提高信誉度'}
                  </p>
                </div>
              </div>
              {!userInfo?.verified && (
          ...
          {userInfo?.verified && (
            <Card title="认证信息">
              <Descriptions column={2}>
                <Descriptions.Item label="企业名称">某某科技有限公司</Descriptions.Item>
                <Descriptions.Item label="统一社会信用代码">91110108MA0XXXXXX</Descriptions.Item>
                <Descriptions.Item label="企业类型">有限责任公司</Descriptions.Item>
