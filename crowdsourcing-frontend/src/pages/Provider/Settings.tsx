...
const SKILL_OPTIONS = [
  'UI设计', 'Logo设计', '品牌设计', '平面设计', '插画设计',
  '动效设计', '视频剪辑', '三维建模', '文案策划', '品牌策划',
  'Photoshop', 'Illustrator', 'Figma', 'Sketch', 'After Effects',
  'Premiere', 'C4D', 'Blender', 'Procreate', 'CorelDRAW',
];
              ...
              <Col xs={24} lg={6}>
                <div className="text-center">
                  ...
                  <div className="mt-2">
                    ...
                    {providerInfo?.level && (
                      <Tag color="gold">L{providerInfo.level} 服务商</Tag>
                    )}
                  </div>
          ...
          <Alert
            ...
            description={
              <div>
                ...
                <Paragraph className="m-0">
                  我同意平台根据相关法律法规对提交的资料进行审核，并有权根据审核结果决定是否通过认证。
                </Paragraph>
              </div>
            }
            type="info"
