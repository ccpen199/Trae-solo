          ...
          <Card title="提交稿件" loading={loading}>
            ...
            >
              <Form.Item
                name="taskId"
                label="选择任务"
                rules={[{ required: true, message: '请选择要提交的任务' }]}
              >
                <Select
                  placeholder="请选择进行中的任务"
              ...
              {selectedTask && (
                ...
                >
                  ...
                  <Descriptions.Item label="任务预算" span={2}>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <Text type="secondary" className="block">从进行中的任务列表选择要提交的任务</Text>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold flex-shrink-0">
