...
export function seed() {
  ...
  const orders = [
    { id: 'ord1', user_id: 'u1', waybill_no: 'YT20250601001', status: 'delivered', service_type: 'standard', weight: 2.5, volume: 0.02, fee: 18.0, sender_name: '张伟', sender_phone: '13800138001', sender_address: '上海市浦东新区陆家嘴环路1000号', receiver_name: '王芳', receiver_phone: '13800138002', receiver_address: '北京市朝阳区建国门外大街1号', package_category: '电子产品', remark: '易碎品请轻放' },
    { id: 'ord2', user_id: 'u1', waybill_no: 'YT20250602002', status: 'in_transit', service_type: 'express', weight: 0.8, volume: 0.005, fee: 25.0, sender_name: '张伟', sender_phone: '13800138001', sender_address: '上海市徐汇区漕溪北路398号', receiver_name: '李娜', receiver_phone: '13800138003', receiver_address: '广州市天河区天河路385号', package_category: '文件', remark: '' },
    { id: 'ord3', user_id: 'u2', waybill_no: 'YT20250603003', status: 'exception', service_type: 'economy', weight: 5.0, volume: 0.08, fee: 15.0, sender_name: '王芳', sender_phone: '13800138002', sender_address: '北京市海淀区中关村大街1号', receiver_name: '刘洋', receiver_phone: '13800138004', receiver_address: '成都市武侯区人民南路四段1号', package_category: '日用品', remark: '大件物品' },
    { id: 'ord4', user_id: 'u3', waybill_no: 'YT20250604004', status: 'picked_up', service_type: 'standard', weight: 1.2, volume: 0.01, fee: 18.0, sender_name: '李娜', sender_phone: '13800138003', sender_address: '广州市越秀区北京路100号', receiver_name: '陈静', receiver_phone: '13800138005', receiver_address: '杭州市西湖区文三路478号', package_category: '食品', remark: '冷藏品' },
    { id: 'ord5', user_id: 'u4', waybill_no: 'YT20250605005', status: 'in_transit', service_type: 'express', weight: 3.0, volume: 0.04, fee: 32.0, sender_name: '刘洋', sender_phone: '13800138004', sender_address: '成都市锦江区春熙路88号', receiver_name: '杨帆', receiver_phone: '13800138006', receiver_address: '深圳市南山区科技南路18号', package_category: '服装', remark: '' },
    { id: 'ord6', user_id: 'u5', waybill_no: 'YT20250606006', status: 'delivered', service_type: 'economy', weight: 1.5, volume: 0.015, fee: 12.0, sender_name: '陈静', sender_phone: '13800138005', sender_address: '杭州市上城区延安路200号', receiver_name: '黄磊', receiver_phone: '13800138007', receiver_address: '南京市鼓楼区中山路100号', package_category: '书籍', remark: '' },
    { id: 'ord7', user_id: 'u6', waybill_no: 'YT20250607007', status: 'out_for_delivery', service_type: 'standard', weight: 2.0, volume: 0.025, fee: 20.0, sender_name: '杨帆', sender_phone: '13800138006', sender_address: '深圳市福田区深南大道6011号', receiver_name: '周敏', receiver_phone: '13800138008', receiver_address: '武汉市江汉区解放大道1000号', package_category: '化妆品', remark: '小心轻放' },
    { id: 'ord8', user_id: 'u7', waybill_no: 'YT20250608008', status: 'pending', service_type: 'standard', weight: 0.5, volume: 0.003, fee: 15.0, sender_name: '黄磊', sender_phone: '13800138007', sender_address: '南京市玄武区珠江路300号', receiver_name: '吴强', receiver_phone: '13800138009', receiver_address: '西安市碑林区长安北路1号', package_category: '文件', remark: '急件' },
    { id: 'ord9', user_id: 'u8', waybill_no: 'YT20250609009', status: 'in_transit', service_type: 'express', weight: 4.0, volume: 0.06, fee: 38.0, sender_name: '周敏', sender_phone: '13800138008', sender_address: '武汉市武昌区东湖路100号', receiver_name: '赵雪', receiver_phone: '13800138010', receiver_address: '重庆市渝中区解放碑步行街88号', package_category: '家电', remark: '' },
    { id: 'ord10', user_id: 'u9', waybill_no: 'YT20250610010', status: 'delivered', service_type: 'economy', weight: 3.5, volume: 0.05, fee: 18.0, sender_name: '吴强', sender_phone: '13800138009', sender_address: '西安市雁塔区高新路50号', receiver_name: '孙磊', receiver_phone: '13800138011', receiver_address: '苏州市工业园区星海街100号', package_category: '日用品', remark: '' },
    { id: 'ord11', user_id: 'u10', waybill_no: 'YT20250611011', status: 'exception', service_type: 'standard', weight: 1.8, volume: 0.02, fee: 22.0, sender_name: '赵雪', sender_phone: '13800138010', sender_address: '重庆市江北区观音桥步行街50号', receiver_name: '马丽', receiver_phone: '13800138012', receiver_address: '天津市和平区南京路100号', package_category: '服装', remark: '' },
    { id: 'ord12', user_id: 'u11', waybill_no: 'YT20250612012', status: 'in_transit', service_type: 'standard', weight: 2.2, volume: 0.03, fee: 24.0, sender_name: '孙磊', sender_phone: '13800138011', sender_address: '苏州市姑苏区观前街100号', receiver_name: '朱杰', receiver_phone: '13800138013', receiver_address: '青岛市市南区香港中路88号', package_category: '食品', remark: '' },
    { id: 'ord13', user_id: 'u12', waybill_no: 'YT20250613013', status: 'picked_up', service_type: 'express', weight: 0.6, volume: 0.004, fee: 28.0, sender_name: '马丽', sender_phone: '13800138012', sender_address: '天津市河西区友谊路30号', receiver_name: '胡婷', receiver_phone: '13800138014', receiver_address: '长沙市天心区芙蓉南路100号', package_category: '文件', remark: '合同文件' },
    { id: 'ord14', user_id: 'u13', waybill_no: 'YT20250614014', status: 'delivered', service_type: 'economy', weight: 6.0, volume: 0.1, fee: 25.0, sender_name: '朱杰', sender_phone: '13800138013', sender_address: '青岛市崂山区海尔路50号', receiver_name: '郭鹏', receiver_phone: '13800138015', receiver_address: '沈阳市和平区青年大街100号', package_category: '家居', remark: '大件' },
    { id: 'ord15', user_id: 'u14', waybill_no: 'YT20250615015', status: 'out_for_delivery', service_type: 'standard', weight: 1.0, volume: 0.008, fee: 16.0, sender_name: '胡婷', sender_phone: '13800138014', sender_address: '长沙市岳麓区麓山南路100号', receiver_name: '何晶', receiver_phone: '13800138016', receiver_address: '济南市历下区泉城路100号', package_category: '化妆品', remark: '' },
    { id: 'ord16', user_id: 'u15', waybill_no: 'YT20250616016', status: 'in_transit', service_type: 'standard', weight: 2.8, volume: 0.035, fee: 26.0, sender_name: '郭鹏', sender_phone: '13800138015', sender_address: '沈阳市沈河区中街路100号', receiver_name: '罗勇', receiver_phone: '13800138017', receiver_address: '郑州市金水区花园路100号', package_category: '电子产品', remark: '' },
    { id: 'ord17', user_id: 'u16', waybill_no: 'YT20250617017', status: 'pending', service_type: 'economy', weight: 4.5, volume: 0.07, fee: 22.0, sender_name: '何晶', sender_phone: '13800138016', sender_address: '济南市天桥区无影山路50号', receiver_name: '梁霞', receiver_phone: '13800138018', receiver_address: '西安市未央区未央路100号', package_category: '日用品', remark: '' },
    { id: 'ord18', user_id: 'u17', waybill_no: 'YT20250618018', status: 'delivered', service_type: 'express', weight: 1.5, volume: 0.015, fee: 30.0, sender_name: '罗勇', sender_phone: '13800138017', sender_address: '郑州市二七区大学路100号', receiver_name: '宋涛', receiver_phone: '13800138019', receiver_address: '昆明市五华区青年路100号', package_category: '文件', remark: '加急' },
    { id: 'ord19', user_id: 'u18', waybill_no: 'YT20250619019', status: 'in_transit', service_type: 'standard', weight: 3.2, volume: 0.045, fee: 28.0, sender_name: '梁霞', sender_phone: '13800138018', sender_address: '西安市新城区解放路100号', receiver_name: '林燕', receiver_phone: '13800138020', receiver_address: '厦门市思明区中山路100号', package_category: '服装', remark: '' },
    { id: 'ord20', user_id: 'u19', waybill_no: 'YT20250620020', status: 'exception', service_type: 'economy', weight: 2.0, volume: 0.025, fee: 14.0, sender_name: '宋涛', sender_phone: '13800138019', sender_address: '昆明市盘龙区北京路100号', receiver_name: '张伟', receiver_phone: '13800138001', receiver_address: '上海市浦东新区张江高科技园区', package_category: '书籍', remark: '' },
    { id: 'ord21', user_id: 'u20', waybill_no: 'YT20250621021', status: 'out_for_delivery', service_type: 'standard', weight: 0.9, volume: 0.006, fee: 17.0, sender_name: '林燕', sender_phone: '13800138020', sender_address: '厦门市湖里区嘉禾路100号', receiver_name: '王芳', receiver_phone: '13800138002', receiver_address: '北京市海淀区学院路100号', package_category: '食品', remark: '' },
    { id: 'ord22', user_id: 'u1', waybill_no: 'YT20250622022', status: 'in_transit', service_type: 'express', weight: 5.5, volume: 0.09, fee: 45.0, sender_name: '张伟', sender_phone: '13800138001', sender_address: '上海市静安区南京西路1266号', receiver_name: '李娜', receiver_phone: '13800138003', receiver_address: '广州市海珠区新港东路100号', package_category: '家电', remark: '小心轻放' },
  ]
  ...
  const generateNodes = (waybillNo: string, status: string, startCity: string, endCity: string) => {
    const nodes: any[] = []
    const baseTime = '2025-06-' + String(Math.floor(Math.random() * 20) + 1).padStart(2, '0')
  ...
  const trackings = [
    { id: 'trk1', order_id: 'ord1', waybill_no: 'YT20250601001', status: 'delivered', startCity: '上海', endCity: '北京' },
    { id: 'trk2', order_id: 'ord2', waybill_no: 'YT20250602002', status: 'in_transit', startCity: '上海', endCity: '广州' },
    { id: 'trk3', order_id: 'ord3', waybill_no: 'YT20250603003', status: 'exception', startCity: '北京', endCity: '成都' },
    { id: 'trk4', order_id: 'ord4', waybill_no: 'YT20250604004', status: 'picked_up', startCity: '广州', endCity: '杭州' },
    { id: 'trk5', order_id: 'ord5', waybill_no: 'YT20250605005', status: 'in_transit', startCity: '成都', endCity: '深圳' },
    { id: 'trk6', order_id: 'ord6', waybill_no: 'YT20250606006', status: 'delivered', startCity: '杭州', endCity: '南京' },
    { id: 'trk7', order_id: 'ord7', waybill_no: 'YT20250607007', status: 'out_for_delivery', startCity: '深圳', endCity: '武汉' },
    { id: 'trk8', order_id: 'ord8', waybill_no: 'YT20250608008', status: 'pending', startCity: '南京', endCity: '西安' },
    { id: 'trk9', order_id: 'ord9', waybill_no: 'YT20250609009', status: 'in_transit', startCity: '武汉', endCity: '重庆' },
    { id: 'trk10', order_id: 'ord10', waybill_no: 'YT20250610010', status: 'delivered', startCity: '西安', endCity: '上海' },
    { id: 'trk11', order_id: 'ord11', waybill_no: 'YT20250611011', status: 'exception', startCity: '重庆', endCity: '北京' },
    { id: 'trk12', order_id: 'ord12', waybill_no: 'YT20250612012', status: 'in_transit', startCity: '上海', endCity: '广州' },
    { id: 'trk13', order_id: 'ord13', waybill_no: 'YT20250613013', status: 'picked_up', startCity: '北京', endCity: '长沙' },
    { id: 'trk14', order_id: 'ord14', waybill_no: 'YT20250614014', status: 'delivered', startCity: '广州', endCity: '沈阳' },
    { id: 'trk15', order_id: 'ord15', waybill_no: 'YT20250615015', status: 'out_for_delivery', startCity: '成都', endCity: '济南' },
    { id: 'trk16', order_id: 'ord16', waybill_no: 'YT20250616016', status: 'in_transit', startCity: '杭州', endCity: '郑州' },
    { id: 'trk17', order_id: 'ord17', waybill_no: 'YT20250617017', status: 'pending', startCity: '武汉', endCity: '西安' },
    { id: 'trk18', order_id: 'ord18', waybill_no: 'YT20250618018', status: 'delivered', startCity: '南京', endCity: '昆明' },
    { id: 'trk19', order_id: 'ord19', waybill_no: 'YT20250619019', status: 'in_transit', startCity: '西安', endCity: '厦门' },
    { id: 'trk20', order_id: 'ord20', waybill_no: 'YT20250620020', status: 'exception', startCity: '昆明', endCity: '上海' },
    { id: 'trk21', order_id: 'ord21', waybill_no: 'YT20250621021', status: 'out_for_delivery', startCity: '厦门', endCity: '北京' },
    { id: 'trk22', order_id: 'ord22', waybill_no: 'YT20250622022', status: 'in_transit', startCity: '上海', endCity: '广州' },
  ]
  ...
  for (const t of trackings) {
    ...
    const estDelivery = t.status === 'delivered' ? null : '2025-06-' + String(Math.floor(Math.random() * 5) + 20).padStart(2, '0')
  ...
  const alerts = [
    { id: 'alert1', order_id: 'ord3', waybill_no: 'YT20250603003', type: 'stagnant', level: 'high', stagnant_hours: 48, status: 'pending', assignee: null, remarks: JSON.stringify([]) },
    { id: 'alert2', order_id: 'ord11', waybill_no: 'YT20250611011', type: 'stagnant', level: 'high', stagnant_hours: 36, status: 'processing', assignee: '李运营', remarks: JSON.stringify([{ author: '李运营', content: '已联系收件人确认地址', time: '2025-06-05 10:00' }]) },
    { id: 'alert3', order_id: 'ord20', waybill_no: 'YT20250620020', type: 'stagnant', level: 'medium', stagnant_hours: 24, status: 'pending', assignee: null, remarks: JSON.stringify([]) },
    { id: 'alert4', order_id: 'ord2', waybill_no: 'YT20250602002', type: 'stagnant', level: 'medium', stagnant_hours: 12, status: 'resolved', assignee: '李运营', remarks: JSON.stringify([{ author: '李运营', content: '快件已恢复正常运输', time: '2025-06-04 16:00' }]) },
    { id: 'alert5', order_id: 'ord5', waybill_no: 'YT20250605005', type: 'stagnant', level: 'low', stagnant_hours: 8, status: 'pending', assignee: null, remarks: JSON.stringify([]) },
    { id: 'alert6', order_id: 'ord7', waybill_no: 'YT20250607007', type: 'delivery_delay', level: 'medium', stagnant_hours: 0, status: 'processing', assignee: '王管理', remarks: JSON.stringify([{ author: '王管理', content: '正在协调派送资源', time: '2025-06-05 09:00' }]) },
    { id: 'alert7', order_id: 'ord9', waybill_no: 'YT20250609009', type: 'stagnant', level: 'low', stagnant_hours: 6, status: 'resolved', assignee: '李运营', remarks: JSON.stringify([{ author: '李运营', content: '已解决', time: '2025-06-04 14:00' }]) },
    { id: 'alert8', order_id: 'ord12', waybill_no: 'YT20250612012', type: 'stagnant', level: 'low', stagnant_hours: 5, status: 'pending', assignee: null, remarks: JSON.stringify([]) },
    { id: 'alert9', order_id: 'ord16', waybill_no: 'YT20250616016', type: 'delivery_delay', level: 'low', stagnant_hours: 0, status: 'pending', assignee: null, remarks: JSON.stringify([]) },
    { id: 'alert10', order_id: 'ord19', waybill_no: 'YT20250619019', type: 'stagnant', level: 'medium', stagnant_hours: 18, status: 'processing', assignee: '李运营', remarks: JSON.stringify([{ author: '李运营', content: '正在处理中', time: '2025-06-06 10:00' }]) },
    { id: 'alert11', order_id: 'ord1', waybill_no: 'YT20250601001', type: 'complaint', level: 'high', stagnant_hours: 0, status: 'resolved', assignee: '王管理', remarks: JSON.stringify([{ author: '王管理', content: '已妥善处理用户投诉', time: '2025-06-03 15:00' }]) },
    { id: 'alert12', order_id: 'ord6', waybill_no: 'YT20250606006', type: 'damage', level: 'high', stagnant_hours: 0, status: 'processing', assignee: '李运营', remarks: JSON.stringify([{ author: '李运营', content: '正在核实损坏情况', time: '2025-06-05 11:00' }]) },
    { id: 'alert13', order_id: 'ord10', waybill_no: 'YT20250610010', type: 'stagnant', level: 'low', stagnant_hours: 4, status: 'resolved', assignee: null, remarks: JSON.stringify([]) },
    { id: 'alert14', order_id: 'ord14', waybill_no: 'YT20250614014', type: 'complaint', level: 'medium', stagnant_hours: 0, status: 'pending', assignee: null, remarks: JSON.stringify([]) },
    { id: 'alert15', order_id: 'ord15', waybill_no: 'YT20250615015', type: 'stagnant', level: 'low', stagnant_hours: 3, status: 'pending', assignee: null, remarks: JSON.stringify([]) },
    { id: 'alert16', order_id: 'ord18', waybill_no: 'YT20250618018', type: 'damage', level: 'medium', stagnant_hours: 0, status: 'resolved', assignee: '王管理', remarks: JSON.stringify([{ author: '王管理', content: '已完成赔偿处理', time: '2025-06-04 17:00' }]) },
    { id: 'alert17', order_id: 'ord21', waybill_no: 'YT20250621021', type: 'delivery_delay', level: 'medium', stagnant_hours: 0, status: 'processing', assignee: '李运营', remarks: JSON.stringify([{ author: '李运营', content: '已联系快递员', time: '2025-06-06 14:00' }]) },
    { id: 'alert18', order_id: 'ord22', waybill_no: 'YT20250622022', type: 'stagnant', level: 'low', stagnant_hours: 2, status: 'pending', assignee: null, remarks: JSON.stringify([]) },
    { id: 'alert19', order_id: 'ord4', waybill_no: 'YT20250604004', type: 'pickup_delay', level: 'low', stagnant_hours: 0, status: 'resolved', assignee: null, remarks: JSON.stringify([]) },
    { id: 'alert20', order_id: 'ord8', waybill_no: 'YT20250608008', type: 'pickup_delay', level: 'medium', stagnant_hours: 0, status: 'pending', assignee: null, remarks: JSON.stringify([]) },
    { id: 'alert21', order_id: 'ord13', waybill_no: 'YT20250613013', type: 'pickup_delay', level: 'low', stagnant_hours: 0, status: 'processing', assignee: '李运营', remarks: JSON.stringify([{ author: '李运营', content: '已安排快递员上门', time: '2025-06-06 09:00' }]) },
    { id: 'alert22', order_id: 'ord17', waybill_no: 'YT20250617017', type: 'stagnant', level: 'low', stagnant_hours: 1, status: 'pending', assignee: null, remarks: JSON.stringify([]) },
  ]
  ...
  const tickets = [
    { id: 'tkt1', user_id: 'u1', subject: '快件YT20250601001配送问题', status: 'resolved', messages: JSON.stringify([{ role: 'user', content: '我的快件显示已签收，但我没收到', time: '2025-06-02 16:00' }, { role: 'bot', content: '您好，已为您查询到该快件状态。显示已签收，签收人：前台。', time: '2025-06-02 16:01' }, { role: 'user', content: '好的，我去前台看看，谢谢', time: '2025-06-02 16:05' }]) },
    { id: 'tkt2', user_id: 'u2', subject: '运费计算疑问', status: 'resolved', messages: JSON.stringify([{ role: 'user', content: '我寄了一个1.2kg的件到杭州，为什么收了18元？', time: '2025-06-03 10:00' }, { role: 'bot', content: '您好，标准件首重1kg收费18元，续重0.2kg按2元/kg计算，共计18.4元，实收18元（已优惠）。', time: '2025-06-03 10:01' }, { role: 'user', content: '明白了，谢谢', time: '2025-06-03 10:05' }]) },
    { id: 'tkt3', user_id: 'u3', subject: '优惠券使用问题', status: 'in_progress', messages: JSON.stringify([{ role: 'user', content: '我有一张5元优惠券，下单时为什么不能用？', time: '2025-06-04 09:00' }, { role: 'bot', content: '您好，正在为您查询优惠券信息，请稍等。', time: '2025-06-04 09:01' }, { role: 'agent', content: '您好，您的优惠券需要满20元才能使用，您当前订单金额为18元，所以无法使用。', time: '2025-06-04 09:10' }]) },
    { id: 'tkt4', user_id: 'u4', subject: '快件损坏赔偿', status: 'open', messages: JSON.stringify([{ role: 'user', content: '我的快件收到时外包装损坏，里面的东西也坏了', time: '2025-06-05 14:00' }, { role: 'bot', content: '非常抱歉给您带来不便，已为您转人工处理。', time: '2025-06-05 14:01' }]) },
    { id: 'tkt5', user_id: 'u5', subject: '改地址申请', status: 'resolved', messages: JSON.stringify([{ role: 'user', content: '我要修改收件地址', time: '2025-06-03 11:00' }, { role: 'agent', content: '请问您的运单号是多少？', time: '2025-06-03 11:05' }, { role: 'user', content: 'YT20250606006', time: '2025-06-03 11:06' }, { role: 'agent', content: '已为您修改地址，新地址：南京市鼓楼区中山路100号', time: '2025-06-03 11:10' }]) },
    { id: 'tkt6', user_id: 'u6', subject: '发票开具问题', status: 'open', messages: JSON.stringify([{ role: 'user', content: '我上个月的发票还没收到', time: '2025-06-05 10:00' }, { role: 'bot', content: '您好，请提供您的订单号和邮箱，我们为您查询。', time: '2025-06-05 10:01' }]) },
    { id: 'tkt7', user_id: 'u7', subject: '投诉快递员服务态度', status: 'in_progress', messages: JSON.stringify([{ role: 'user', content: '今天送快递的那个人态度太差了！', time: '2025-06-04 17:00' }, { role: 'bot', content: '非常抱歉给您带来不好的体验，我们会严肃处理。', time: '2025-06-04 17:01' }, { role: 'agent', content: '您好，已记录您的投诉，我们会对该快递员进行批评教育，感谢您的反馈。', time: '2025-06-05 09:00' }]) },
    { id: 'tkt8', user_id: 'u8', subject: '关于保价服务的咨询', status: 'resolved', messages: JSON.stringify([{ role: 'user', content: '保价费怎么收？', time: '2025-06-02 15:00' }, { role: 'bot', content: '保价费为保价金额的千分之五，最低2元。', time: '2025-06-02 15:01' }]) },
    { id: 'tkt9', user_id: 'u9', subject: '寄件时效咨询', status: 'resolved', messages: JSON.stringify([{ role: 'user', content: '从西安寄到上海要多久？', time: '2025-06-01 09:00' }, { role: 'bot', content: '您好，标准件2-3天，经济件3-5天，急件1-2天。', time: '2025-06-01 09:01' }]) },
    { id: 'tkt10', user_id: 'u10', subject: '快件丢了怎么办', status: 'in_progress', messages: JSON.stringify([{ role: 'user', content: '我的快递一周了还没到，是不是丢了？', time: '2025-06-05 16:00' }, { role: 'bot', content: '您好，请提供运单号，我帮您查询。', time: '2025-06-05 16:01' }, { role: 'user', content: 'YT20250611011', time: '2025-06-05 16:02' }, { role: 'agent', content: '您好，已为您查询，该快件目前在天津中转，因天气原因有所延误，预计明天送达。', time: '2025-06-05 16:20' }]) },
    { id: 'tkt11', user_id: 'u11', subject: '上门取件时间', status: 'open', messages: JSON.stringify([{ role: 'user', content: '我今天下午能寄件吗？', time: '2025-06-06 08:00' }, { role: 'bot', content: '可以的，您下单后快递员会在2小时内上门。', time: '2025-06-06 08:01' }]) },
    { id: 'tkt12', user_id: 'u12', subject: '月结账户申请', status: 'resolved', messages: JSON.stringify([{ role: 'user', content: '怎么申请月结账户？', time: '2025-06-01 14:00' }, { role: 'agent', content: '您好，申请月结账户需要企业资质，月发件量50票以上。请提供企业营业执照和法人身份证照片到企业服务邮箱。', time: '2025-06-01 14:30' }, { role: 'user', content: '好的，谢谢', time: '2025-06-01 14:35' }]) },
    { id: 'tkt13', user_id: 'u13', subject: '大件物流咨询', status: 'in_progress', messages: JSON.stringify([{ role: 'user', content: '我要寄一台冰箱，你们收吗？', time: '2025-06-04 10:00' }, { role: 'bot', content: '可以的，我们有大件物流服务。', time: '2025-06-04 10:01' }, { role: 'agent', content: '您好，冰箱属于大件物品，需要走大件物流专线。请问重量和尺寸大概是多少？', time: '2025-06-04 10:30' }]) },
    { id: 'tkt14', user_id: 'u14', subject: '国际件咨询', status: 'resolved', messages: JSON.stringify([{ role: 'user', content: '能寄到日本吗？', time: '2025-06-02 11:00' }, { role: 'bot', content: '可以的，支持全球200多个国家和地区。', time: '2025-06-02 11:01' }, { role: 'user', content: '运费多少？', time: '2025-06-02 11:02' }, { role: 'agent', content: '到日本首重1kg 80元，续重每500g 25元。', time: '2025-06-02 11:10' }]) },
    { id: 'tkt15', user_id: 'u15', subject: '冷链运输价格', status: 'open', messages: JSON.stringify([{ role: 'user', content: '冷链运输怎么收费？', time: '2025-06-06 09:00' }, { role: 'bot', content: '正在为您转人工客服，请稍候。', time: '2025-06-06 09:01' }]) },
    { id: 'tkt16', user_id: 'u16', subject: '会员积分问题', status: 'resolved', messages: JSON.stringify([{ role: 'user', content: '积分怎么获得？有什么用？', time: '2025-06-03 16:00' }, { role: 'bot', content: '每消费1元获得1积分，积分可以兑换优惠券和礼品。', time: '2025-06-03 16:01' }]) },
    { id: 'tkt17', user_id: 'u17', subject: '派送时间请求', status: 'in_progress', messages: JSON.stringify([{ role: 'user', content: '我的件能不能周末再送？', time: '2025-06-05 12:00' }, { role: 'agent', content: '可以的，请提供运单号，我帮您备注。', time: '2025-06-05 12:10' }, { role: 'user', content: 'YT20250616016', time: '2025-06-05 12:11' }]) },
    { id: 'tkt18', user_id: 'u18', subject: '自提网点查询', status: 'resolved', messages: JSON.stringify([{ role: 'user', content: '西安雁塔区有自提点吗？', time: '2025-06-01 10:00' }, { role: 'bot', content: '有的，雁塔区高新路25号有一个网点，营业时间09:00-18:00。', time: '2025-06-01 10:01' }]) },
    { id: 'tkt19', user_id: 'u19', subject: '禁寄物品询问', status: 'resolved', messages: JSON.stringify([{ role: 'user', content: '充电宝能寄吗？', time: '2025-06-02 14:00' }, { role: 'bot', content: '充电宝可以寄，但只能走陆运，不能空运。', time: '2025-06-02 14:01' }]) },
    { id: 'tkt20', user_id: 'u20', subject: '包装材料购买', status: 'open', messages: JSON.stringify([{ role: 'user', content: '你们有纸箱卖吗？', time: '2025-06-06 11:00' }, { role: 'bot', content: '有的，有多种规格的纸箱和包装材料可供选择。', time: '2025-06-06 11:01' }]) },
    { id: 'tkt21', user_id: 'u1', subject: '申请退款', status: 'in_progress', messages: JSON.stringify([{ role: 'user', content: '我要取消订单退款', time: '2025-06-06 13:00' }, { role: 'agent', content: '好的，请问您的订单号是？', time: '2025-06-06 13:05' }]) },
    { id: 'tkt22', user_id: 'u2', subject: '表扬快递员', status: 'resolved', messages: JSON.stringify([{ role: 'user', content: '今天给我送件的快递员服务特别好，要表扬！', time: '2025-06-04 18:00' }, { role: 'bot', content: '非常感谢您的认可，我们会转达您的表扬！', time: '2025-06-04 18:01' }]) },
  ]
