...
export const mockGuideResponses: Record<string, GuideResponse> = {
  default: {
    intent: 'general_query',
    matchedServices: mockServices.slice(0, 3),
    handlingPath: [
      { step: 1, title: '在线预约', description: '通过本平台预约办理时间', department: '政务服务中心', duration: '5分钟' },
      { step: 2, title: '准备材料', description: '按照要求准备相关材料', department: '申请人', duration: '1-3天' },
      { step: 3, title: '提交申请', description: '在线提交申请和材料', department: '政务服务中心', duration: '10分钟' },
      { step: 4, title: '审核办理', description: '相关部门审核并办理', department: '各业务部门', duration: '3-5个工作日' },
    ],
    materialList: [
      { id: 'g1', name: '居民身份证', type: 'id_card', isElectronic: true, required: true, description: '有效期内的二代身份证' },
    ],
