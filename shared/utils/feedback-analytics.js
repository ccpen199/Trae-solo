...
exports.clusterFeedbacks = clusterFeedbacks;
exports.analyzeFeedbackTrend = analyzeFeedbackTrend;
exports.generateWorkOrderFromFeedback = generateWorkOrderFromFeedback;
...
function clusterFeedbacks(feedbacks, similarityThreshold = 0.6) {
...
function generateClusterName(keywords, feedbacks) {
...
function analyzeClusterCategory(keywords, feedbacks) {
    const categoryMap = {
...
function generateSuggestion(keywords, feedbacks) {
...
function analyzeFeedbackTrend(feedbacks, periodDays = 30) {
    const result = [];
    const now = new Date();
...
function generateWorkOrderFromFeedback(feedback) {
    const now = new Date();
    const ratingPriorityMap = {
        1: 'urgent',
        2: 'high',
        3: 'medium',
        4: 'low',
...
//# sourceMappingURL=feedback-analytics.js.map