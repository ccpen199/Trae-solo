...
start_detached "may-89046-backend" "$PROJECT_DIR/backend" "$PROJECT_DIR/backend.log" "$PROJECT_DIR/backend.log" env BACKEND_PORT="$BACKEND_PORT" FRONTEND_PORT="$FRONTEND_PORT" "$NODE_BIN" server.js

sleep 3

echo "Starting frontend on http://127.0.0.1:$FRONTEND_PORT"
start_detached "may-89046-frontend" "$PROJECT_DIR/frontend" "$PROJECT_DIR/frontend.log" "$PROJECT_DIR/frontend.log" env BACKEND_PORT="$BACKEND_PORT" FRONTEND_PORT="$FRONTEND_PORT" "$PROJECT_DIR/frontend/node_modules/.bin/vite" --host 127.0.0.1 --port "$FRONTEND_PORT" --strictPort
