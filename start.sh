...
start_detached "may-89047-backend" "$PROJECT_DIR/backend" "$PROJECT_DIR/backend.log" "$PROJECT_DIR/backend.err.log" "$NODE_BIN" server.js

sleep 3

echo "Starting frontend on http://127.0.0.1:$FRONTEND_PORT"
start_detached "may-89047-frontend" "$PROJECT_DIR/frontend" "$PROJECT_DIR/frontend.log" "$PROJECT_DIR/frontend.err.log" "$PROJECT_DIR/frontend/node_modules/.bin/vite" --host 127.0.0.1 --port "$FRONTEND_PORT" --strictPort
