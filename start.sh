...
FRONTEND_PORT="$(resolve_port FRONTEND_PORT "${FRONTEND_PORT:-43449}")"
BACKEND_PORT="$(resolve_port BACKEND_PORT "${BACKEND_PORT:-53449}")"
...
export FRONTEND_PORT BACKEND_PORT VITE_API_BASE_URL="http://127.0.0.1:$BACKEND_PORT/api"

rm -f "$PROJECT_DIR/backend.log" "$PROJECT_DIR/frontend.log" "$PROJECT_DIR/frontend-build.log"

echo "Starting Parking Guidance System..."
echo "Frontend Port: $FRONTEND_PORT"
echo "Backend Port: $BACKEND_PORT"

BACKEND_COMMAND="$(build_launch_command "$PROJECT_DIR/backend" "$NODE_BIN" "src/index.js")"
