...
ENV_FILE="$ROOT/.env"
BASE_PORT="${FRONTEND_PORT:-48829}"
PORT="$BASE_PORT"
BACKEND_HEALTH_URL="http://127.0.0.1:${BACKEND_PORT:-58829}/api/health"
...
exec "$ROOT/node_modules/.bin/vite" --host 127.0.0.1 --port "$PORT" --strictPort
