...
export const mockServices: ServiceItem[] = [
  ...
  },
  {
    ...
    departmentId: '2',
    department: '公安厅',
    description: '来京人员居住证申领，支持在线填报、证照免交和材料上传识别',
    handlingTime: '5个工作日',
    hotLevel: 823,
    isOnline: true,
    requiredMaterials: [
      { id: 'm16', name: '居民身份证', type: 'id_card', isElectronic: true, required: true, description: '有效期内的二代身份证（支持电子证照免交）' },
      { id: 'm17', name: '居住证明', type: 'other', isElectronic: false, required: true, description: '租房合同或房产证明（支持OCR识别上传）' },
      { id: 'm18', name: '近期照片', type: 'other', isElectronic: false, required: false, description: '一寸白底免冠照片（支持拍照上传）' },
    ],
    formFields: [
      { id: 'f30', name: 'name', label: '申请人姓名', type: 'text', required: true, prefillSource: 'id_card' },
      { id: 'f31', name: 'idCard', label: '身份证号', type: 'text', required: true, prefillSource: 'id_card' },
      { id: 'f32', name: 'phone', label: '联系电话', type: 'text', required: true },
      { id: 'f33', name: 'residenceAddress', label: '居住地址', type: 'textarea', required: true },
      { id: 'f34', name: 'residenceType', label: '居住类型', type: 'select', required: true, options: [
        { label: '租赁房屋', value: 'rent' },
        { label: '自有房屋', value: 'own' },
        { label: '单位宿舍', value: 'dorm' },
        { label: '寄住', value: 'hosted' },
      ]},
    ],
  },
  {
    ...
    departmentId: '2',
    department: '公安厅',
    description: '居民身份证期满换领、损坏换领、丢失补领，在线申请+人脸识别核验',
    handlingTime: '7个工作日',
    hotLevel: 791,
    isOnline: true,
    requiredMaterials: [
      { id: 'm19', name: '原居民身份证', type: 'id_card', isElectronic: true, required: false, description: '换领需提交原证，补领无需提交（电子证照可免交）' },
      { id: 'm20', name: '人像照片', type: 'other', isElectronic: false, required: true, description: '现场人像采集或上传照片（支持拍照识别）' },
    ],
    formFields: [
      { id: 'f35', name: 'name', label: '申请人姓名', type: 'text', required: true, prefillSource: 'id_card' },
      { id: 'f36', name: 'idCard', label: '身份证号', type: 'text', required: true, prefillSource: 'id_card' },
      { id: 'f37', name: 'applyType', label: '申请类型', type: 'select', required: true, options: [
        { label: '期满换领', value: 'expire' },
        { label: '损坏换领', value: 'damage' },
        { label: '丢失补领', value: 'lost' },
      ]},
      { id: 'f38', name: 'phone', label: '联系电话', type: 'text', required: true },
      { id: 'f39', name: 'pickupMethod', label: '领取方式', type: 'select', required: true, options: [
        { label: '邮寄到家', value: 'mail' },
        { label: '窗口自取', value: 'window' },
      ]},
    ],
  },
  {
    ...
    departmentId: '2',
    department: '公安厅',
    description: '个人无犯罪记录证明在线申请，电子签名确认，证明直达账户',
    handlingTime: '3个工作日',
    hotLevel: 756,
    isOnline: true,
    requiredMaterials: [
      { id: 'm21', name: '居民身份证', type: 'id_card', isElectronic: true, required: true, description: '有效期内的二代身份证（支持电子证照免交）' },
    ],
    formFields: [
      { id: 'f40', name: 'name', label: '申请人姓名', type: 'text', required: true, prefillSource: 'id_card' },
      { id: 'f41', name: 'idCard', label: '身份证号', type: 'text', required: true, prefillSource: 'id_card' },
      { id: 'f42', name: 'phone', label: '联系电话', type: 'text', required: true },
      { id: 'f43', name: 'purpose', label: '用途说明', type: 'select', required: true, options: [
        { label: '就业', value: 'employment' },
        { label: '出国', value: 'abroad' },
        { label: '入学', value: 'enrollment' },
...
export const menuItems: MenuItem[] = [
  ...
  { key: 'applications', label: '我的办件', icon: 'ClipboardList', path: '/my-applications' },
  {
    ...
    label: '后台管理',
    icon: 'Settings',
    roles: ['staff', 'admin', 'platform', 'ops'],
    children: [
