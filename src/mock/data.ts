...
export const mockCases: Case[] = [
  ...
  buildCase({ id: 'case-011', designerId: 'designer-005', designerName: designerMap['designer-005'].name, designerAvatar: designerMap['designer-005'].avatar, title: 'SOHO现代城·ins风温馨一居', city: '北京', district: '朝阳区', houseType: '一室一厅一卫', area: 45, rooms: 1, bathrooms: 1, style: 'ins风', budget: 68000, duration: 45, floorPlanSvg: floorPlans[2], description: '小户型极致利用，ins风温馨设计，打造属于年轻人的舒适小窝。', tags: ['ins风', '一居', '小户型', '温馨'], seed: 11, qualityScore: 4.42, views: 4580, createdAt: new Date('2025-03-22') }),
  buildCase({ id: 'case-012', designerId: 'designer-001', designerName: designerMap['designer-001'].name, designerAvatar: designerMap['designer-001'].avatar, title: '青年公寓·日式极简一居', city: '上海', district: '静安区', houseType: '一室零厅一卫', area: 38, rooms: 1, bathrooms: 1, style: '日式', budget: 52000, duration: 40, floorPlanSvg: floorPlans[2], description: '日式极简风格，多功能收纳设计，让小空间也能井井有条。', tags: ['日式', '一居', '小户型', '收纳'], seed: 12, qualityScore: 4.65, views: 6120, createdAt: new Date('2025-02-28') }),
  buildCase({ id: 'case-013', designerId: 'designer-002', designerName: designerMap['designer-002'].name, designerAvatar: designerMap['designer-002'].avatar, title: '绿城玫瑰园·欧式古典别墅', city: '苏州', district: '工业园区', houseType: '别墅', area: 268, rooms: 5, bathrooms: 4, style: '欧式古典', budget: 950000, duration: 180, floorPlanSvg: floorPlans[1], description: '欧式古典风格别墅，华丽雕花与精致线条，彰显尊贵生活品质。', tags: ['欧式古典', '别墅', '大户型', '奢华'], seed: 13, qualityScore: 4.88, views: 21350, createdAt: new Date('2024-10-15') }),
  buildCase({ id: 'case-014', designerId: 'designer-003', designerName: designerMap['designer-003'].name, designerAvatar: designerMap['designer-003'].avatar, title: '天津湾·地中海浪漫两居', city: '天津', district: '河西区', houseType: '两室两厅一卫', area: 92, rooms: 2, bathrooms: 1, style: '地中海', budget: 185000, duration: 75, floorPlanSvg: floorPlans[0], description: '地中海风格设计，蓝白配色与拱形元素，仿佛置身爱琴海之畔。', tags: ['地中海', '两居', '浪漫', '蓝白'], seed: 14, qualityScore: 4.78, views: 9870, createdAt: new Date('2025-01-08') }),
];
