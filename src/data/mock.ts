...
export interface NewsItem {
  id: string;
  category: "policy" | "transport" | "medical" | "culture" | "finance";
  title: string;
  summary: string;
  time: string;
}
...
export interface ServiceItem {
  ...
  icon: string;
  color: string;
  roles: ("official" | "enterprise" | "citizen" | "tourist")[];
  link: string;
}
...
export const mockIdentityProviders: IdentityProvider[] = [
  { provider: "govcloud", label: "广西政务云", status: "connected", lastAuth: "2026-06-15 09:30" },
  { provider: "unionpay", label: "银联认证", status: "connected", lastAuth: "2026-06-14 14:20" },
  { provider: "wechat", label: "微信", status: "connected", lastAuth: "2026-06-15 08:15" },
...
export const mockTourRoutes: TourRoute[] = [
...
export const mockComplaints: Complaint[] = [
  { id: "c1", title: "景区停车收费不合理", content: "黄姚古镇停车场收费50元/次，远超周边景区标准，且无公示价目表。", status: "processing", createdAt: "2026-06-14", reply: undefined },
  ...
  { id: "c3", title: "景区卫生间不足", content: "银滩景区夏季客流高峰时卫生间排队超30分钟，建议增设移动卫生间。", status: "submitted", createdAt: "2026-06-15" },
];

export const mockSubsidies: SubsidyApplication[] = [
  {
  ...
  },
  {
    ...
    timeline: [
      { step: "资格自动核验", date: "2026-06-15", status: "current" },
...
export const mockMedicalInsurance: MedicalInsurance = {
  balance: 12856.5,
  monthlyDeposit: 680,
...
export const mockPolicyFulfillments: PolicyFulfillment[] = [
