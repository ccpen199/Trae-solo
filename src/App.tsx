    ...
    <Router>
      <Routes>
        ...
        <Route path="/tasks" element={
          <ProtectedRoute allowedRoles={['courier', 'admin', 'operator']}>
            <TaskList />
          </ProtectedRoute>
        } />
        ...
        <Route path="/offline-pickup" element={
          <ProtectedRoute allowedRoles={['courier']}>
            <OfflinePickup />
          </ProtectedRoute>
        } />

        <Route path="/waybill-template" element={
          <ProtectedRoute allowedRoles={['admin', 'operator']}>
            <WaybillTemplate />
          </ProtectedRoute>
        } />

        <Route path="/waybill-account" element={
          <ProtectedRoute allowedRoles={['admin', 'operator']}>
            <WaybillAccount />
          </ProtectedRoute>
        } />

        <Route path="/waybill-recharge" element={
          <ProtectedRoute allowedRoles={['admin', 'operator']}>
            <WaybillRecharge />
          </ProtectedRoute>
        } />
