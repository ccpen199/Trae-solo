...
export const TestAccounts: Array<{
  username: string;
  password: string;
  role: UserRole;
  name: string;
  ...
  { username: 'dealer1', password: '123456', role: 'dealer', name: '诚信二手车行' },
  { username: 'buyer1', password: '123456', role: 'buyer', name: '张先生' },
  { username: 'inspector1', password: '123456', role: 'inspector', name: '李检测师' },
  { username: 'sales1', password: '123456', role: 'sales', name: '王销售' },
  { username: 'cs1', password: '123456', role: 'customer_service', name: '赵客服' },
  { username: 'finance1', password: '123456', role: 'finance', name: '孙财务' }
];
