...
export default function QRCodePage() {
  const [qrStyle, setQrStyle] = useState<'classic' | 'brand' | 'minimal'>('brand')
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200">
            ...
            <div className="flex items-center gap-2 mb-6">
              {[
                ...
                <button
                  key={s.key}
                  onClick={() => setQrStyle(s.key as typeof qrStyle)}
            ...
            <div className="mt-6 p-4 bg-slate-50 rounded-xl border border-slate-200">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="px-4 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-lg text-sm font-medium flex items-center gap-1.5 hover:shadow-lg transition">
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-3">
                {[
                  { icon: MessageCircle, label: '微信', color: 'from-green-500 to-emerald-600' },
                  { icon: Users, label: '朋友圈', color: 'from-sky-500 to-blue-600' },
                  { icon: Mail, label: '短信', color: 'from-violet-500 to-purple-600' },
                  { icon: Share2, label: '更多', color: 'from-slate-500 to-slate-600' },
                ].map((item) => {
