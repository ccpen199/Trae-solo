...
const servicesData: Service[] = [
  ...
  { id: 'trafficfine', title: '违章查询', icon: CarTaxiFront, color: 'text-yellow-600', bgColor: 'bg-yellow-100', category: 'traffic', desc: '机动车违法记录' },
  ...
  { id: 'taxpay', title: '税务服务', icon: BadgeYen, color: 'text-emerald-600', bgColor: 'bg-emerald-100', category: 'gov', desc: '个税申报、发票服务' },
