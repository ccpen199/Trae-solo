...
import { Megaphone, TrendingUp, ArrowRight, Flame, Clock } from 'lucide-react'
    ...
    <div>
      <section className="relative bg-gradient-to-r from-navy-800 to-navy-600 text-white py-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          <h1 className="font-serif text-4xl font-bold mb-4">全国分类信息公共服务平台</h1>
          <p className="text-navy-200 text-lg mb-8">UGC+PGC混合治理 · 12大类目 · 地理围栏智能匹配</p>
          <div className="flex justify-center gap-4">
            <Link to="/publish" className="btn-accent">发布信息</Link>
            <Link to="/voice-search" className="btn-outline border-white text-white hover:bg-white/10">语音搜索</Link>
          </div>
        </div>
      </section>
