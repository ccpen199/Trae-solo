...
const processes: Process[] = [
  { id: 'p1', name: '强电回路布设', stage: 'hydropower', gbCount: 5, duration: '2-3天', difficulty: '高', description: '根据用电负载合理分配回路，大功率电器独立回路',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('electrical wiring renovation site circuit breaker distribution box professional construction, documentary photography') + '&image_size=landscape_4_3&seed=501' },
  { id: 'p2', name: '弱电综合布线', stage: 'hydropower', gbCount: 3, duration: '1-2天', difficulty: '中', description: '网络、电视、电话、智能系统点位布置',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('structured cabling network cable routing home renovation site, documentary photography') + '&image_size=landscape_4_3&seed=502' },
  { id: 'p3', name: '给水PPR管安装', stage: 'hydropower', gbCount: 4, duration: '2天', difficulty: '高', description: '冷热水管分色布管，左热右冷，横平竖直',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('PPR water pipe installation plumbing renovation blue red pipes, construction site photography') + '&image_size=landscape_4_3&seed=503' },
  { id: 'p4', name: '排水坡度施工', stage: 'hydropower', gbCount: 3, duration: '1天', difficulty: '中', description: '确保排水通畅，干湿区坡度分别控制',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('floor drain slope construction bathroom drainage system, renovation site photography') + '&image_size=landscape_4_3&seed=504' },
  { id: 'p5', name: '卫生间防水层', stage: 'hydropower', gbCount: 6, duration: '2天', difficulty: '高', description: '三遍涂刷工艺，48小时闭水试验',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('bathroom waterproof coating application blue membrane construction site, renovation photography') + '&image_size=landscape_4_3&seed=505' },
  { id: 'p6', name: '全屋水管打压', stage: 'hydropower', gbCount: 2, duration: '0.5天', difficulty: '低', description: '1.0MPa压力30分钟压降≤0.05MPa',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('water pressure test gauge plumbing system testing, construction site photography') + '&image_size=landscape_4_3&seed=506' },

  { id: 'p7', name: '墙地面找平', stage: 'tile', gbCount: 3, duration: '2-3天', difficulty: '中', description: '2米靠尺误差≤3mm，为后续铺贴打基础',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('floor screed leveling cement mortar construction site, renovation photography') + '&image_size=landscape_4_3&seed=507' },
  { id: 'p8', name: '瓷砖薄贴工艺', stage: 'tile', gbCount: 5, duration: '5-7天', difficulty: '高', description: '齿形刮板配合瓷砖胶，空鼓率≤5%',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('tile adhesive thin-set installation trowel notched trowel, tiling construction site') + '&image_size=landscape_4_3&seed=508' },
  { id: 'p9', name: '大地板砖干铺', stage: 'tile', gbCount: 4, duration: '4-6天', difficulty: '高', description: '半干湿砂浆垫层，平整度更高',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('large format tile dry laying method floor installation, construction site photography') + '&image_size=landscape_4_3&seed=509' },
  { id: 'p10', name: '墙砖铺贴', stage: 'tile', gbCount: 4, duration: '5-6天', difficulty: '中', description: '预排砖、找规矩、墙压地工艺',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('wall tile installation ceramic tile bathroom tiling worker, construction site photography') + '&image_size=landscape_4_3&seed=510' },
  { id: 'p11', name: '美缝填缝施工', stage: 'tile', gbCount: 2, duration: '1-2天', difficulty: '低', description: '瓷砖铺贴7天后进行，色彩持久防霉',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('epoxy grout sealing tile joints beautiful seam work, construction detail photography') + '&image_size=landscape_4_3&seed=511' },

  { id: 'p12', name: '轻钢龙骨吊顶', stage: 'carpentry', gbCount: 4, duration: '3-5天', difficulty: '高', description: '主龙骨间距≤800mm，防开裂处理',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('light steel keel ceiling framework installation gypsum board, construction site photography') + '&image_size=landscape_4_3&seed=512' },
  { id: 'p13', name: '定制衣柜安装', stage: 'carpentry', gbCount: 3, duration: '2-3天', difficulty: '中', description: '现场精准调平，五金件顺滑耐用',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('custom wardrobe cabinet installation interior carpentry work, construction site photography') + '&image_size=landscape_4_3&seed=513' },
  { id: 'p14', name: '实木门套制作', stage: 'carpentry', gbCount: 3, duration: '1-2天', difficulty: '中', description: '45度对角拼接，门扇垂直偏差≤2mm',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('wooden door frame installation carpentry work interior door, construction site photography') + '&image_size=landscape_4_3&seed=514' },
  { id: 'p15', name: '背景墙木饰面', stage: 'carpentry', gbCount: 3, duration: '2-3天', difficulty: '高', description: '基层防潮处理，饰面拼接无缝',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('wood veneer feature wall paneling installation interior carpentry, construction site photography') + '&image_size=landscape_4_3&seed=515' },

  { id: 'p16', name: '墙面基层处理', stage: 'paint', gbCount: 5, duration: '4-6天', difficulty: '高', description: '嵌缝→找平→挂网→三遍腻子',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('wall putty plastering surface preparation painting process, construction site photography') + '&image_size=landscape_4_3&seed=516' },
  { id: 'p17', name: '乳胶漆涂刷', stage: 'paint', gbCount: 4, duration: '3-4天', difficulty: '中', description: '底漆一遍面漆两遍，无流坠无漏刷',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('latex paint roller wall painting interior renovation, worker using paint roller photography') + '&image_size=landscape_4_3&seed=517' },
  { id: 'p18', name: '艺术漆质感涂', stage: 'paint', gbCount: 3, duration: '5-7天', difficulty: '高', description: '肌理效果专业施工，色彩均匀一致',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('artistic paint texture wall finish decorative coating application, interior design photography') + '&image_size=landscape_4_3&seed=518' },
  { id: 'p19', name: '石膏线安装', stage: 'paint', gbCount: 2, duration: '1-2天', difficulty: '低', description: '快粘粉固定，阴阳角拼接严密',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('plaster cornice moulding installation ceiling decoration, construction detail photography') + '&image_size=landscape_4_3&seed=519' },
  { id: 'p20', name: '木作清漆涂装', stage: 'paint', gbCount: 3, duration: '3-5天', difficulty: '高', description: '三底两面工艺，手感光滑无颗粒',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('wood furniture varnish clear coat spray painting finish, carpentry workshop photography') + '&image_size=landscape_4_3&seed=520' },

  { id: 'p21', name: '木地板铺装', stage: 'installation', gbCount: 4, duration: '2-3天', difficulty: '中', description: '悬浮式铺装，伸缩缝预留规范',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('wood laminate floor installation floating flooring system, construction interior photography') + '&image_size=landscape_4_3&seed=521' },
  { id: 'p22', name: '定制橱柜安装', stage: 'installation', gbCount: 3, duration: '2天', difficulty: '高', description: '地柜调平、吊柜承重、台面拼接',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('custom kitchen cabinet installation countertop sink fitting, interior renovation photography') + '&image_size=landscape_4_3&seed=522' },
  { id: 'p23', name: '卫浴五金安装', stage: 'installation', gbCount: 3, duration: '1天', difficulty: '中', description: '防水密封处理，承重挂件牢固',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('bathroom fixtures installation faucet shower hardware fitting, construction detail photography') + '&image_size=landscape_4_3&seed=523' },
  { id: 'p24', name: '开关插座安装', stage: 'installation', gbCount: 3, duration: '1天', difficulty: '低', description: '水平一致，相邻面板间隙≤0.5mm',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('electrical switch socket outlet wall installation, electrician work detail photography') + '&image_size=landscape_4_3&seed=524' },
  { id: 'p25', name: '灯具安装调试', stage: 'installation', gbCount: 2, duration: '1天', difficulty: '中', description: '承重挂钩、水平定位、电路检测',
    image: '/api/ide/v1/text_to_image?prompt=' + encodeURIComponent('chandelier pendant light installation ceiling wiring, electrician work photography') + '&image_size=landscape_4_3&seed=525' },
];
