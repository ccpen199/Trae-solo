...
export default function Navbar() {
  ...
  const { currentRole, isLoggedIn, userInfo, logout } = useAppStore()
          ...
          <AnimatePresence>
            {dropdownOpen && isLoggedIn && (
              <motion.div
                ...
                className="absolute right-0 mt-2 w-44 bg-white rounded-lg shadow-gov-lg border border-gov-border overflow-hidden"
              >
                ...
                <div className="border-t border-gov-border">
                  <button
                    ...
                    className="w-full text-left px-4 py-2.5 text-sm text-gov-red hover:bg-gov-red/5 transition-colors duration-150"
                  >
                    退出登录
                  </button>
                </div>
