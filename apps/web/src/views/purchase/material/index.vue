  ...
  <div class="material-management">
    <el-card shadow="never">
      ...
      <el-table :data="materialList" style="width: 100%">
        ...
        <el-table-column prop="code" label="原料编码" />
    ...
    >
      <el-form
        ...
        label-width="100px"
      >
        <el-form-item label="原料编码" prop="code" v-if="!isEdit">
          <el-input v-model="form.code" placeholder="请输入原料编码" />
        </el-form-item>
        ...
        <el-form-item label="安全库存" prop="safetyStock">
          <el-input v-model.number="form.safetyStock" placeholder="请输入安全库存" type="number" />
        </el-form-item>
      </el-form>
      <template #footer>
...
const handleDelete = async (id: string) => {
  try {
    await ElMessageBox.confirm('确定删除该原料吗？', '提示', {
...
const handleStatusChange = async (id: string, isActive: boolean) => {
  try {
    await put(`/materials/${id}`, { isActive })
